...
export const VictorinoxPage: React.FC<PageProps> = ({ lang }) => {
   ...
   const categories = [
      { name: 'vic.cat.knives', img: 'https://imageengine.victorinox.com/transform/6682e4f5-e5b0-40bf-819f-9a9e2884e309/SAK_1-3703_B3-jpg?io=transform%3Afill%2Cwidth%3A575%2Cheight%3A575&quality=100', desc: 'vic.desc.knives', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/c/SAK/' },
      { name: 'vic.cat.cutlery', img: 'https://imageengine.victorinox.com/transform/a3429d1f-548a-4dc7-975e-901db428a6ef/CUT_7-7403-20G_7-7323-17G_7-7203-12G_G?io=transform%3Acrop%2Cheight%3A1300%2Cwidth%3A1300%2Cpath%3Asquare&focuspoint=0.53%2C0.52&io=transform%3Afill%2Cwidth%3A575%2Cheight%3A575&quality=100', desc: 'vic.desc.cutlery', link: 'https://www.victorinox.com/en-DE/Products/Cutlery/c/CUT/' },
      { name: 'vic.cat.watches', img: 'https://imageengine.victorinox.com/transform/fc99d1fd-f2e9-401a-9ce3-37986aea74a1/WAT_242024-1_B_1?io=transform%3Afill&focuspoint=0.49%2C0.43&io=transform%3Afill%2Cwidth%3A575%2Cheight%3A575&quality=100', desc: 'vic.desc.watches', link: 'https://www.victorinox.com/en-DE/Products/Watches/c/TP/' },
      { name: 'vic.cat.travel', img: 'https://imageengine.victorinox.com/transform/96d036f1-cf03-4869-85fb-7d96aab69f0a/TGE_Category_Shot_2023_G_1?io=transform%3Acrop%2Cheight%3A1200%2Cwidth%3A1200%2Cpath%3Asquare&focuspoint=0.52%2C0.46&quality=100', desc: 'vic.desc.travel', link: 'https://www.victorinox.com/en-DE/Products/Travel-Gear/c/TRG/' },
      { name: 'vic.cat.fragrance', img: 'https://imageengine.victorinox.com/transform/ba308ade-2e3d-4f00-a4d9-6046810e573e/FRA_V0001247_LS4-jpg?io=transform%3Afill%2Cheight%3A600%2Cwidth%3A600&io=overlay%3Abox%2Ccolor%3A000000%2Copacity%3A10&focuspoint=0.39%2C0.7&quality=100', desc: 'vic.desc.fragrance', link: 'https://www.victorinox.com/en-DE/Products/Fragrances/c/FRA/' },
   ];

   const handleBrowseGifts = (e: React.MouseEvent) => {
       e.preventDefault();
      ...
      <div className="bg-white min-h-screen text-slate-900 font-sans">
         ...
         <div className="relative h-[700px] w-full overflow-hidden">
             ...
             <div className="absolute inset-0 bg-black/20 flex flex-col justify-center px-16 relative z-10">
                 ...
                 <button 
                    ...
                    className="bg-[#b10034] text-white font-bold py-4 px-8 rounded-md w-fit hover:bg-[#8a1b14] transition-colors uppercase tracking-wide text-sm shadow-xl inline-block cursor-pointer"
                 >
                     {t['vic.browse_gift']}
                 </button>
             </div>
         ...
         <div id="categories" className="container mx-auto px-4 py-20">
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 ...
                 {/* Bestsellers Tile */}
                 <a 
                    href="https://www.victorinox.com/en-DE/Best-Selling-Pocket-Knives/cms/best-selling-pocket-knives/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative h-[500px] bg-gray-100 flex items-center justify-center cursor-pointer hover:bg-gray-200 transition-colors block"
                 >
         ...
         <div id="onyx" className="bg-slate-900 dark:bg-[#050505] text-white py-24 border-y border-gray-800 relative overflow-hidden transition-colors duration-300">
         ...
         <div id="new-arrivals" className="bg-gray-50 dark:bg-[#111] py-20 transition-colors duration-300">
             <div className="container mx-auto px-4">
                     ...
                     {standardProducts.slice(0, 4).map(p => {
                         return (
                             <div key={p.id} className="group bg-white dark:bg-[#1a1a1a] p-4 transition-all duration-300 hover:shadow-xl shadow-sm border border-gray-100 dark:border-[#333]">
                                 <Link to={`/product/${p.id}`} className="block relative h-64 mb-4 overflow-hidden bg-white dark:bg-[#111]">
                                     <img src={p.images[0]} className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110" />
                                 </Link>
                                 <Link to={`/product/${p.id}`}>
                                    <h4 className="font-bold text-slate-800 dark:text-white mb-1 line-clamp-1 group-hover:text-[#b10034] transition-colors">{p.name}</h4>
                                 </Link>
         ...
         {/* Lifestyle Section */}
         <div id="lifestyle" className="container mx-auto px-4 py-20">
             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                 {[
                     { title: 'Everyday', img: 'https://imageengine.victorinox.com/transform/e4afb0f1-220b-45d1-a7da-f061890f0cbb/SAK_Master_the_Moment_0-8231-26_LS_3-jpg?io=transform%3Afill%2Cwidth%3A480%2Cheight%3A872&quality=100', link: 'https://www.victorinox.com/en-DE/cms/sak-everyday/' },
                     { title: 'Outdoor & Sports', img: 'https://imageengine.victorinox.com/transform/7b9752a1-5859-4703-8f22-d11f3684acc4/SAK_B2M_OB_1080x1920px_Outdoor_Sports_1-3713_LS_1_withoutLogo?quality=100', link: 'https://www.victorinox.com/en-DE/cms/sak-outdoor-and-sports/' },
                     { title: 'Trades & Crafts', img: 'https://imageengine.victorinox.com/transform/9b81c4eb-eaf7-492d-a7ee-b90bce830417/SAK_B2M_Trades_Crafts_3-0339-N_LS_1?io=transform%3Acrop%2Cheight%3A1080%2Cwidth%3A684%2Cpath%3Asquare&focuspoint=0.42%2C0.48&quality=100', link: 'https://www.victorinox.com/en-DE/cms/sak-trades-and-crafts/' },
                     { title: 'Accessories', img: 'https://imageengine.victorinox.com/transform/e0cb811b-04d3-4c54-9672-50142f45cc5b/SAK_Segmentation_Accessories_G-jpg?io=transform%3Afill%2Cheight%3A880%2Cwidth%3A484&focuspoint=0.54%2C0.57&quality=100', link: 'https://www.victorinox.com/en-DE/cms/sak-accessories/' },
                 ].map((item, idx) => (
                     <a 
                        key={idx} 
                        href={item.link}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="relative h-[400px] group cursor-pointer overflow-hidden rounded-lg block"
                     >
         ...
         <div className="bg-gray-100 dark:bg-[#1a1a1a] py-16 transition-colors duration-300">
            <div className="container mx-auto px-4">
                ...
                <div className="flex gap-6 overflow-x-auto pb-4 no-scrollbar">
                    {[
                        { name: 'Small Pocket Knives', img: 'https://imageengine.victorinox.com/transform/3394ae99-399a-430f-a166-d1acb32666f2/SAK_Small_PocketKnives-jpg?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Small-Pocket-Knives/c/SAK_SmallPocketKnives/' },
                        { name: 'Medium Pocket Knives', img: 'https://imageengine.victorinox.com/transform/65f4fb66-87ad-405f-993b-a94a257c3edb/SAK_Medium_PocketKnives_B1-jpg?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Medium-Pocket-Knives/c/SAK_MediumPocketKnives/' },
                        { name: 'Large Pocket Knives', img: 'https://imageengine.victorinox.com/transform/86993d21-4690-40a7-a402-76cff9d58631/SAK_Large_PocketKnives_B2-jpg?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Large-Pocket-Knives/c/SAK_LargePocketKnives/' },
                        { name: 'Swiss Tools', img: 'https://imageengine.victorinox.com/transform/a973fb3c-3fe8-4e4a-ac11-0fdaba48ecb4/SAK_Swiss_Tool_Extension_1080x1080_G_3-jpg?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Swiss-Tools/c/SAK_SwissTool/' },
                        { name: 'Swiss Cards', img: 'https://imageengine.victorinox.com/transform/5d63db0b-eae3-4830-a68a-07f4f85e506f/SAK_Swiss_Cards_B1-jpg?io=transform%3Acrop%2Cheight%3A1000%2Cwidth%3A1000%2Cpath%3Asquare&io=overlay%3Abox%2Ccolor%3A666%2Copacity%3A20&focuspoint=0.48%2C0.44&io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Swiss-Cards/c/SAK_SwissCard/' },
                    ].map((cat, idx) => (
                        <a 
                           key={idx} 
                           href={cat.link}
                           target="_blank"
                           rel="noopener noreferrer"
                           className="flex-shrink-0 w-48 group cursor-pointer block"
                        >
         ...
         {/* Collections Banner */}
         <div id="collections" className="container mx-auto px-4 py-20">
             <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 uppercase">Shop by Collection</h2>
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                 {[
                     { name: 'Alox Refined', img: 'https://imageengine.victorinox.com/transform/75557ed0-9ca7-4fee-9b0a-734c01bbf1b6/SAK_Alox_Refined_G1?io=transform%3Acrop%2Cheight%3A1500%2Cwidth%3A1500%2Cpath%3Asquare&focuspoint=0.49%2C0.44&io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Alox-Refined/collection/sak-collection/sak_collection_SAK-C086/' },
                     { name: 'Companion', img: 'https://imageengine.victorinox.com/transform/19b501f9-40c4-4648-8082-b581ce269bf0/SAK_-0-8170-20_B?io=transform%3Acrop%2Cheight%3A1000%2Cwidth%3A1000%2Cpath%3Asquare&focuspoint=0.48%2C0.59&io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Companion/collection/sak-collection/sak_collection_SAK-C084/' },
                     { name: 'Alox Limited', img: 'https://imageengine.victorinox.com/transform/947eb278-37b4-4fca-bd0d-f6eb7f4ba338/SAK_Alox_LE_StoneRed_G_1080x1080px_240919_RR?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Alox-Limited-Edition/cms/alox-limited-edition/' },
                     { name: 'Limited Ed.', img: 'https://imageengine.victorinox.com/transform/fe1d5133-768f-400d-9075-6a15ffb2f704/SAK_1-3603-T21E1_B_1080x1080px?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Products/Swiss-Army-Knife%E2%84%A2-and-Tools/Limited-edition/collection/sak-collection/sak_collection_SAK-C000/' },
                     { name: 'Live to Explore', img: 'https://imageengine.victorinox.com/transform/e5df0dce-959c-45d5-9dad-6b7c1dc9ed36/SAK_Live_to_Explore_G_SoMe_1080x1620px-jpg?io=transform%3Afill%2Cwidth%3A360%2Cheight%3A360&quality=100', link: 'https://www.victorinox.com/en-DE/Live-to-Explore-Collection/cms/live-to-explore-collection/' },
                     { name: 'Evoke', img: 'https://imageengine.victorinox.com/transform/8aafdacf-c91b-45ad-856d-50c04be4516b/SAK_Evoke_G-jpg?io=transform%3Acrop%2Cheight%3A1040%2Cwidth%3A1920%2Cpath%3Asquare&focuspoint=0.48%2C0.57&quality=100', link: 'https://www.victorinox.com/en-DE/Evoke-Alox/cms/evoke-collection/' },
                 ].map((col, idx) => (
                     <a 
                        key={idx} 
                        href={col.link}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-center group cursor-pointer text-slate-900 dark:text-white block"
                     >
